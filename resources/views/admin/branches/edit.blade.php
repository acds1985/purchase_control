                  ...
                  <form method="post" action="{{route('branches.update',['branch' => $branch->id])}}">
                    ...
                    <div class="card-body row">
                      <div class="form-group col-md-6">
                        ...
                        value="{{old('social_name') ?? $branch->social_name}}">
                      </div>
                      <div class="form-group col-md-6">
                        ...
                        value="{{old('alias_name') ?? $branch->alias_name}}">
                      </div>
                      <div class="form-group col-md-6">
                        ...
                        value="{{old('document_company') ?? $branch->document_company}}">
                      </div>
                      <div class="form-group col-md-6">
                        ...
                        value="{{old('document_company_secondary') ?? $branch->document_company_secondary}}">
                      </div>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        value="{{old('neighborhood') ?? $branch->neighborhood}}">
                      </div>
                      <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control select2" name="user" id="user">
                          ...
                          <option value="{{$user->id}}" {{ $user->id === $branch->user ? 'selected' : '' }}>{{ $user->name }} ( {{$user->email}}) </option>
